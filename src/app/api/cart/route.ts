 ...
 * checkout URL. The client is expected to redirect (window.location.href)
 * to that URL — payment then happens entirely on Shopify's PCI-compliant
 * infrastructure.
 *
 * Responses:
 ...
 *  502 { error }       — Shopify rejected the cart (variant not found,
 *                        out of stock, etc.) — caller should fall back
 *                        to the simulated checkout
 */
