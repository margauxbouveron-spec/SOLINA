...
export default function CartPage() {
  ...
  return (
    <section className="gutter mx-auto max-w-[1400px] pt-32">
      <header>
        <div className="eyebrow text-ink/55">Panier</div>
      ...
      {items.length === 0 ? (
        <div className="mt-20 border-t border-ink/15 py-20 text-center">
          <p className="font-editorial text-2xl text-ink/70">
        ...
        <div className="mt-16 grid gap-16 lg:grid-cols-12">
          <ul className="divide-y divide-ink/10 border-y border-ink/15 lg:col-span-8">
            {items.map((item) => (
              <li key={item.id} className="grid grid-cols-12 items-center gap-4 py-8">
                ...
                <div className="col-span-9 sm:col-span-5">
                  <Link
                    ...
                    className="font-editorial text-2xl hover:text-ink/70"
                  >
                    {item.name}
                  </Link>
                  <div className="mt-1 text-[11px] uppercase tracking-[0.32em] text-ink/55">
                ...
                <div className="col-span-6 text-right sm:col-span-3">
                  ...
                  <button
                    ...
                    className="mt-1 text-[10px] uppercase tracking-[0.32em] text-ink/45 hover:text-ink"
                  >
                    Retirer
                  </button>
                </div>
          ...
          <aside className="lg:col-span-4">
            <div className="border border-ink/15 p-8">
              <div className="eyebrow text-ink/55">Résumé</div>
              <dl className="mt-6 space-y-3 text-sm text-ink/70">
                ...
                <div className="flex justify-between border-t border-ink/15 pt-4 font-editorial text-2xl text-ink">
                  <dt>Total</dt>
                  <dd>{formatPrice(subtotal, currency)}</dd>
                </div>
              </dl>
